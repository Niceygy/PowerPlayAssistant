...
var POWER_RENFORCE_PREFERENCES = map[string][]string{
	"ALD": {"BTHT", "CEPD", "HSHK"},
	"ARD": {"BTHT", "PKLS", "RSGD"},
	"ASD": {"BTHT", "PKLS", "RSGD"},
	"DPT": {"BTHT", "CEPD", "HSHK"},
...
var POWER_PERKS = map[string]string{
	"ALD": "+100% Bounty Payouts, -30% Weapon Costs",
	"ARD": "+30% black market profits, -100% reduced value on bounties placed on you",
	"ASD": "+100% minor faction rep gain, +200% search & rescue payout",
	"DPT": "+80% bounty payouts, -90% rearm prices & -40% weapon cost",
	"EMH": "+100% minor faction gain, +50% bonds for rare goods & +25% trade bonds",
	"FLW": "+60% food & medicine profits, +100% minor faction gain & +100% salvage profits",
	"JRA": "+100% bounty payouts & -30% weapon costs",
	"LYR": "-100% R/R/R costs, +25% trade bonds",
	"NAK": "+50% mining profits, +150% minor faction rep gain & +120% S&R profits",
	"PRA": "+30& exobio profits, +150% minor faction rep gain & +50% tech trade profits",
	"YRG": "",
	"ZMT": "Zemina Torval",
} //Perks that powers offer

var POWER_BEST_FOR = map[string]string{
	"ALD": "Bounty Hunters",
	"ARD": "Smugglers",
